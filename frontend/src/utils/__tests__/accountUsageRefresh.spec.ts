  ...
  it('会在重置次数快照变化时生成不同 key', () => {
    const base = {
      ...
      extra: {
        ...
        codex_reset_credit_fetched_at: '2026-03-07T10:00:00Z'
      }
    } as any
    ...
    const next = {
      ...
      extra: {
        ...base.extra,
        codex_reset_credit_available_count: 1,
        codex_reset_credit_fetched_at: '2026-03-07T11:00:00Z'
      }
    }
