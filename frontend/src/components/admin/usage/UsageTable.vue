        ...
        <template #cell-tokens="{ row }">
          ...
          <div v-else class="flex items-center gap-1.5">
            <div class="space-y-1 text-sm">
              ...
              <div v-if="cacheReadTokenTotal(row) > 0 || hasCacheCreationTokens(row)" class="flex items-center gap-2">
                <div v-if="cacheReadTokenTotal(row) > 0" class="inline-flex items-center gap-1">
                  ...
                  <span class="font-medium text-sky-600 dark:text-sky-400">{{ formatCacheTokens(cacheReadTokenTotal(row)) }}</span>
                </div>
                <div v-if="hasCacheCreationTokens(row)" class="inline-flex items-center gap-1">
                  ...
                  <span class="font-medium text-amber-600 dark:text-amber-400">{{ formatCacheTokens(cacheCreationTokenTotal(row)) }}</span>
