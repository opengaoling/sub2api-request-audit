export default {
  ...
  usage: {
    ...
    cacheCreationTokenPrice: '缓存创建单价',
  ...
  admin: {
    ...
    accounts: {
      ...
      headerOverride: {
        ...
        addRow: '添加请求头',
        fillTemplate: '填入所选模板',
        builtinTemplate: '平台内置客户端模板',
        refreshTemplates: '刷新采集模板',
        clearAll: '一键清空',
        capturedTemplateHint: '采集模板来自“设置 → 网关设置”记录的客户端请求指纹；填入时覆盖同名指纹头，保留其他自定义请求头。',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        autoFingerprint: '自动：按账号采集指纹',
        autoFingerprintHint: '未选择全局指纹时，每个 OAuth 账号继续使用自身采集到的指纹。',
        refreshFingerprints: '刷新',
        fingerprintSaved: '全局指纹已保存',
      ...
      openaiFastPolicy: {
        ...
        scopeBedrock: '仅 Bedrock 账号',
        userIds: '指定用户',
        userIdsHint: '留空表示全局规则；填写用户 ID 后仅对这些用户生效，用户专属规则优先于全局规则。',
