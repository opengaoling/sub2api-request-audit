export default {
  ...
  usage: {
    ...
    cacheCreationTokenPrice: 'Cache creation price',
  ...
  admin: {
    ...
    accounts: {
      ...
      headerOverride: {
        ...
        claudeCodeMimicry: 'Full Claude Code Mimicry',
        claudeCodeMimicryHint: 'Rewrites headers, the system prompt, and metadata.user_id for API-key upstreams that only accept Claude Code clients.',
        ...
        addRow: 'Add Header',
        fillTemplate: 'Fill Selected Template',
        builtinTemplate: 'Built-in Client Template',
        refreshTemplates: 'Refresh Captures',
        clearAll: 'Clear All',
        capturedTemplateHint: 'Captured templates come from client request fingerprints recorded under Settings → Gateway Settings. Matching fingerprint headers are replaced while other custom headers are preserved.',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        autoFingerprint: 'Automatic: per-account fingerprint',
        autoFingerprintHint: 'Without a global selection, each OAuth account keeps its own collected fingerprint.',
        refreshFingerprints: 'Refresh',
        fingerprintSaved: 'Global fingerprint saved',
      ...
      openaiFastPolicy: {
        ...
        userIdsHint: 'Leave empty for a global rule. User-specific rules take precedence over global rules.',
