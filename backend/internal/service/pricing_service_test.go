...
func TestGetModelPricing_Gpt56UsesDedicatedStaticFallbackWhenRemoteMissing(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gpt-5.6-terra", inputPrice: 2e-6, outputPrice: 1.2e-5, cacheCreation: 2.5e-6, cacheCreationPriority: 5e-6, cacheRead: 2e-7, inputPriority: 4e-6, outputPriority: 2.4e-5, cachePriority: 4e-7},
		{model: "gpt-5.6-luna", inputPrice: 0.2e-6, outputPrice: 1.2e-6, cacheCreation: 0.25e-6, cacheCreationPriority: 0.5e-6, cacheRead: 0.02e-6, inputPriority: 0.4e-6, outputPriority: 2.4e-6, cachePriority: 0.04e-6},
	}
	for _, tt := range tests {
		t.Run(tt.model, func(t *testing.T) {
